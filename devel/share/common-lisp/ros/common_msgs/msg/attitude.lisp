...
(cl:defmethod cl:initialize-instance :after ((m <attitude>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'attitude)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-msg:<attitude> is deprecated: use common_msgs-msg:attitude instead.")))
