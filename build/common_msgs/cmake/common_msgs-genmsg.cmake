...
message(STATUS "common_msgs: 1 messages, 0 services")

set(MSG_I_FLAGS "-Icommon_msgs:/home/osama/global_ws/src/common_msgs/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/osama/global_ws/src/common_msgs/msg/attitude.msg" NAME_WE)
add_custom_target(_common_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "common_msgs" "/home/osama/global_ws/src/common_msgs/msg/attitude.msg" ""
)
...
_generate_msg_cpp(common_msgs
  "/home/osama/global_ws/src/common_msgs/msg/attitude.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/common_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/common_msgs\")")
  # install generated code
  install(
